...
htl.html`## Strong baseline - 利用蘋果成績圖環繞個人照片(小組)`
)}
...
FileAttachment("simple_15_2-1@6.json").json()
)}
...
function _simple_15_212(FileAttachment){return(
FileAttachment("simple_15_2-1@6.json").json()
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
      ["simple_15_2-1@6.json", { url: new URL("./simple_15_2_1.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  ...
  main.variable(observer("simple_15_212")).define("simple_15_212", ["FileAttachment"], _simple_15_212);
  return main;
}
