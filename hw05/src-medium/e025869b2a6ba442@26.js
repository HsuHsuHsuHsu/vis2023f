...
htl.html`## Medium baseline - 滑鼠移動過去顯示該成員相關資訊`
)}
...
htl.html`## Medium baseline - 滑鼠移動過去放大節點與圖片`
)}
...
htl.html`## Medium baseline - 點擊節點可以展開或縮放`
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
      ["output.json", { url: new URL("./simple_15.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
